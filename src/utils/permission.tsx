// from https://github.com/raycast/extensions/blob/main/extensions/iterm/src/core/permission-error-screen.tsx
import { Detail, Action, Icon, ActionPanel } from "@raycast/api";
